...
public class PotatoLaboratory {
    ...
    private static List<Potato> findPotatoesForExperiment(List<Potato> potatoes) {
        List<Potato> modifaibleCopy = new ArrayList<>(potatoes);
        Collections.sort(modifaibleCopy);
        List<Potato> result = new ArrayList<>();
        result.add(modifaibleCopy.get(0));
        result.add(modifaibleCopy.get(1));
        result.add(modifaibleCopy.get(modifaibleCopy.size()-2));
        result.add(modifaibleCopy.get(modifaibleCopy.size()-1));
