        ...
        try {
            ...
            for (int i = 0; i < lines.length - 2; i++) {
                ...
                switch (fields[1]) {
                    ...
                    case "TASK": {
                        Task task = new Task(Integer.parseInt(fields[0]), fields[2], fields[3], Status.valueOf(fields[4]));
                        manager.save(task);
                        taskIdToTask.put(task.id, task);
                        break;
                    }
                    case "SUBTASK": {
                        Subtask subtask = new Subtask(Integer.parseInt(fields[0]), Integer.parseInt(fields[5]), fields[2], fields[3], Status.valueOf(fields[4]));
